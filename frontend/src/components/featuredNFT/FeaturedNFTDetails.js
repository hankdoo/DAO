            ...
            <div className="nft-card card featured-card border-0 bg-gray">
                    ...
                    <Dropdown className={`section-${elem.dropdownVisibility}`} >
                        ...
                        <Dropdown.Menu align="end" >
                            {elem.dropdownInfo.map((item, index) => (
                                <Link key={index} className="dropdown-item" href={item.dropdownItemURL} >
                ...
                <div className="card-body">
                                ...
                                <div className="name-author">
                                    ...
                                    >
                                        <Link 
                                            ...
                                            href={`${process.env.PUBLIC_URL}/featured-items/${elem.id}`}
                                        >
                                            {elem.title}
                                        </Link>
                                    </OverlayTrigger>
                    ...
                    <div className="row gx-2 align-items-center mt-3">
                        <div className="col-6">
                            <Link className={`btn btn-${elem.buttonGroup[0].leftButtonStyle} rounded-pill btn-sm`} href={elem.buttonGroup[0].leftButtonURL} >
                                <i className={`bi ${elem.buttonGroup[0].leftButtonIcon}`} ></i>
                                {elem.buttonGroup[0].leftButtonText}
                            </Link>
                        </div>
                        <div className="col-6 text-end">
                            <Link className={`btn btn-${elem.buttonGroup[1].rightButtonStyle} btn-sm hover-primary`} href={elem.buttonGroup[1].rightButtonURL} >
                        ...
                        <div className="col-12 col-md-9 col-lg-6">
                            <div className="item-details-content mt-5 mt-lg-0">
                                ...
                                <Dropdown className={`section-${featuredData.dropdownVisibility} item-details-dd`} >
                                    ...
                                    <Dropdown.Menu align="end" >
                                        <Link className="dropdown-item" href="#" onClick={() => setModalShow(true)}>
                                            <i className="me-2 bi bi-share" />
                                            Share
                                        </Link>

                                        <Link className="dropdown-item" href="#" onClick={() => setModalShow2(true)}>
                                            <i className="me-2 bi bi-box-arrow-up-right" />
                                            Copy Link
                                        </Link>
                                        
                                        <Link className="dropdown-item" href="#" onClick={() => setModalShow3(true)}>
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    ...
                                    <div className="name-author">
                                        ...
                                        <Link 
                                            ...
                                            href={`${process.env.PUBLIC_URL}/author/${featuredData.authorName}`}
                                        >
                                ...
                                <div className="row align-items-end">
                                    ...
                                    <div className="col-6 col-sm-4 col-lg-5">
                                        <Link className={`btn btn-${featuredData.buttonGroup[0].leftButtonStyle} rounded-pill w-100`} href={featuredData.buttonGroup[0].leftButtonURL} >
                                            <img 
                                                className="me-1" 
