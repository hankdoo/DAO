                        ...
                        <div className="welcome-content mb-5 mb-md-0">
                            ...
                            <ScrollAnimation animateIn="fadeInUp" delay={1200} animateOnce={true} >
                                <div className="hero-btn-group">
                                    <Link className={`btn bg-${btnInfo[0].color} rounded-pill mt-3 me-3`} href={btnInfo[0].path}>
                                        {btnInfo[0].text}
                                        <i className={`ms-2 bi ${btnInfo[0].icon}`}></i>
                                    </Link>
                                    <Link className={`btn btn-${btnInfo[1].color} hover-primary mt-3`} href={btnInfo[1].path}>
