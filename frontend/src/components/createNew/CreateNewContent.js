                        ...
                        <div className="create-new-form border shadow-sm p-4 p-sm-5">
                            ...
                            <Form>
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-12 col-md-6">
                                        <Form.Group className="mb-4">
                                            <Form.Label className="mb-2 fz-16">Catagory</Form.Label>
                                            <Form.Select className="border border-2 w-100" id="catagories" aria-label="Default select example">
                            ...
                            <div className="card-body">
                                    ...
                                    <div className="col-8">
                                        <div className="name-info d-flex align-items-center">
                                            ...
                                            <div className="name-author">
                                                <Link className="name d-block hover-primary text-truncate" href="#">
                                                    {inputTitle}
                                                </Link>
                                                <Link className="author d-block fz-12 hover-primary text-truncate" href="#">
                                                    @creative_art
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                <div className="row gx-2 align-items-center mt-3">
                                    ...
                                    <div className="col-6 text-end">
                                        <Link className="btn btn-minimal btn-sm hover-primary" href="#">
