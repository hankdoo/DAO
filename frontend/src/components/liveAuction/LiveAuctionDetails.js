                        ...
                        <div className="col-8">
                            <div className="name-info d-flex align-items-center">
                                ...
                                <div className="name-author">
                                    ...
                                    >
                                        <Link className="name d-block hover-primary text-truncate" href={`${process.env.PUBLIC_URL}/live-bid/${elem.id}`} >
                                            {elem.title}
                                        </Link>
                                    </OverlayTrigger>
                                    <Link 
                            ...
                            <div className="item-details-content mt-5 mt-lg-0">
                                ...
                                <div className="row align-items-end">
                                    ...
                                    <div className="col-6 col-sm-4 col-lg-5">
                                        <Link className={`btn btn-${bidsdata.buttonInfo[0].style} rounded-pill w-100`} href={bidsdata.buttonInfo[0].url} >
                                            <img 
                                                className="me-1" 
